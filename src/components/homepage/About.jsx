        ...
        <div className="top-20 sm:sticky md:top-28 lg:top-32 md:w-1/2">
          <div className="w-full space-y-4 2xl:space-y-10">
            ...
            <p ref={body} className=" translate-y-10 text-body-1 2xl:text-4xl opacity-0">
              I am the youngest developer in my bloodline, Web_designer, Web_developer and creator based in
              (LHR), Pakistan.
              <br></br>
              <br></br>I specialize in crafting elevated,
              minimalistic web_developer for startups or like small businesses to help
              ...
              that can you see or talk about development, productivity and design on{" "}
              <a
                className="underline duration-300 ease-in-out hover:text-secondary-700"
                href="https://www.instagram.com/un.coder/"
              >
                Instagram📸
              </a>
            </p>
